...
\caption{\small \sl This figure shows results of Nobel prize winning importance.\label{fig:Alphas}} 
\end{center}
\end{figure}
...
\caption{\small \sl This figure shows results of more Nobel prize winning importance.\label{fig:Neurons}} 
\end{center}
\end{figure}
